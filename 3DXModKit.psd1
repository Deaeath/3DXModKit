@{
    ...
    PrivateData = @{
        PSData = @{
            ...
            ReleaseNotes = 'Critical fix: 3dxGC.bat forwarded its own internal -elevated re-launch flag straight to Start-Gui.ps1, which does not accept it - the launcher failed to open for anyone who accepted the UAC prompt.'
        }
    }
}
